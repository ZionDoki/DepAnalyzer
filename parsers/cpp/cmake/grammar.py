"""CMake grammar and shared Lark parser instance."""
...
# Keep grammar identical to the one used previously by the monolithic parser
CMAKE_GRAMMAR = r"""
start: file
...
# Expose a single shared LALR parser instance
CMAKE_PARSER = Lark(CMAKE_GRAMMAR, parser="lalr", propagate_positions=False, maybe_placeholders=False)
