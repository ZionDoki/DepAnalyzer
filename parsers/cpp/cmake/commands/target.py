...
class TargetCommandHandler(CommandHandler):
    ...
    def _create_target_node(
        ...
        """Create a target node in the graph.
        ...
        v = shared_graph.create_vertex(
            ...
            linkage_kind=(
                ...
                if node_type == "shared_library"
                    ...
                    "static"
                    if node_type == "static_library"
                    else "executable" if node_type == "executable" else None
                )
            ),
        )
    ...
    def _add_source_files(
        ...
        """Add source file nodes and edges for a target.
